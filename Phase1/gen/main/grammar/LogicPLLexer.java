...
public class LogicPLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "VALUE", "FLOAT", "INT", 
			"NATURAL_NUMBERS", "FUNCTION", "MAIN", "TYPE", "BOOLEAN", "PRINT", "FOR", 
			"RETURN", "KEYWORDS", "IDENTIFIER", "PRIDICATE", "QUERY_1", "QUERY_2", 
			...
			"OPERATORS", "ARRAY_TYPE", "ARRAY_VALUE", "ARRAY_ELEMENT", "COMMA", "SEMICOLON", 
